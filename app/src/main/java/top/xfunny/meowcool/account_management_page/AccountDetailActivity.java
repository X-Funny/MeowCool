...
public class AccountDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (accountName.equals(DatabaseManager.getSelectedDatabase(context))) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.action_save) {
            ...
            if (!updatedAccountName.equals(tempAccountName)) {
                if (accountName.equals(DatabaseManager.getSelectedDatabase(context))) {
                    DatabaseManager.close(context);
                    DatabaseManager.saveAccountName(accountName, String.format("%s%s", updatedAccountName, ".db"), this);
                    DatabaseManager.open(context, String.format("%s%s", updatedAccountName, ".db"));
                } else {
                    DatabaseManager.saveAccountName(accountName, String.format("%s%s", updatedAccountName, ".db"), this);
