...
public class DatabaseProcessor {
    ...
    public static void showDatabaseSelectDialog(Context context) {//选择账套窗口
        ...
        builder.setPositiveButton(context.getString(R.string.button_ok), (dialog, which) -> {
            DatabaseManager.open(context, listView);
            Toast.makeText(context, context.getString(R.string.selected) + DatabaseManager.getSelectedDatabase(context), Toast.LENGTH_SHORT).show();
    ...
    public static void setTextView1(Context context) {
        String selectedDatabase = DatabaseManager.getSelectedDatabase(context);
